 ...
 * 
 * @author Dominik Bruhn (dominik@dbruhn.de), Axel Busch
 *         (axel.busch@student.kit.edu), Qais Noorshams (noorshams@kit.edu)
 * 
 */
public interface RemoteConnection
{
	...
	/**
	 * @return Return {@code true} when the RemoteConnection is connected to the host, false otherwise.
	 */
